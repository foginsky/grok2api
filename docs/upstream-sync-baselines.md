...
### Local fork landing point (before current selective sync commits)
...
- Reviewed upstream head: `7f4b1dcd752f405a9a1cf6d34e4b60fa7f55a3d8`
- Reviewed head summary: `2026-03-18 fix: 修复 URL 模式历史视频预览解析`
...
- Reviewed upstream head: `635e6e3524c5f54f26cd693b8bf42d64f031503b`
- Reviewed head summary: `2026-03-18 chore: update version to 1.6.2 and adjust related file references`
...
## Current selective sync decision window (reviewed on 2026-03-19)
...
```bash
git log --oneline 7f4b1dcd752f405a9a1cf6d34e4b60fa7f55a3d8..upstream_xianyu/main
git diff --stat 7f4b1dcd752f405a9a1cf6d34e4b60fa7f55a3d8..upstream_xianyu/main
```

### Chenyme incremental range

```bash
git log --oneline 635e6e3524c5f54f26cd693b8bf42d64f031503b..upstream_chenyme/main
git diff --stat 635e6e3524c5f54f26cd693b8bf42d64f031503b..upstream_chenyme/main
```
